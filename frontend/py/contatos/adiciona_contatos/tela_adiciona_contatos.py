...
"}")
        ...
        self.dados_contato = QtWidgets.QLineEdit(self.frame_4)
        self.dados_contato.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setFamily("Garamond")
        font.setPointSize(12)
        font.setBold(True)
        self.dados_contato.setFont(font)
        self.dados_contato.setStyleSheet("background-color: rgb(60,60,60);\n"
"color: rgb(255,255,255);\n"
"border-radius: 15px;\n"
"padding: 10px")
        self.dados_contato.setObjectName("dados_contato")
        self.verticalLayout_3.addWidget(self.dados_contato)
...
"")
    ...
    def retranslateUi(self, Adiciona_Contatos):
        ...
        self.dados_contato.setPlaceholderText(_translate("Adiciona_Contatos", "Adicione os dados aqui"))
